...
QtObject {
    ...
    readonly property bool cycleSelectionWhileHoldingTab: SettingsUtils.settingBool(settingsStore.pluginApi, settingsStore.defaults, ["general.cycleSelectionWhileHoldingTab"], false)
    readonly property bool stopContinuousCycleAtEdge: SettingsUtils.settingBool(settingsStore.pluginApi, settingsStore.defaults, ["general.stopContinuousCycleAtEdge"], false)
}
